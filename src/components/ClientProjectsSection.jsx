...
const ClientProjectsSection = () => {
  const clientProjects = [
    ...
    },
    {
      id: 4,
      title: "Kolula",
      technologies: ["React", "Node", "PostgreSQL", "Redux Toolkit"],
      duration: "13 months"
    },
    {
      id: 5,
    ...
    },
    {
      id: 6,
      title: "Komet",
      technologies: ["Next.js", "Neon", "PostgreSQL", "Geminia API"],
      duration: "1 month"
    },
    {
      id: 7,
      title: "Safe Report",
      technologies: ["Next.js", "Storyblok", "Commence Tools", "Magnolia"],
      duration: "1 month"
    },
    {
      id: 8,
      title: "PickNDrop",
      technologies: ["React Native", "Django", "PostgreSQL", "Redux Toolkit"],
      duration: "1 month"
    }
  ];
